...
internal static class ArmorRenderPatches
{
    ...
    [HarmonyPatch(typeof(EntitySkinnableShapeRenderer), "reloadSkin")]
    public class EntitySkinnableShapeRendererPatch
    {
        [HarmonyTranspiler]
    ...
    private readonly static int[] _renderOrder = new int[]
    {
