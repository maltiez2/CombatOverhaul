...
public class DamageResistData
{
    ...
    private static readonly float[][] _damageReduction = new float[][]
    {
        ...
        new float[] { 0.03f, 0.15f, 0.33f, 0.50f, 0.75f, 1.00f, 1.00f, 1.00f, 1.00f  },
        new float[] { 0.02f, 0.10f, 0.25f, 0.40f, 0.50f, 0.75f, 1.00f, 1.00f, 1.00f  },
        new float[] { 0.01f, 0.05f, 0.20f, 0.33f, 0.40f, 0.50f, 0.75f, 1.00f, 1.00f  },
        new float[] { 0.00f, 0.03f, 0.15f, 0.25f, 0.35f, 0.45f, 0.50f, 0.75f, 1.00f  },
